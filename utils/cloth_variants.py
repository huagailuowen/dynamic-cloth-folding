...
CLOTH_VARIANTS = {
    ...
    "light": {
        "description": "Light cloth: 18x18 grid with one twentieth of the normal density.",
        "model_kwargs_rownum": 0,
        "cloth_grid_count": 18,
        "geom_density": 50.0,
        "skin_inflate": 0.001,
    ...
    "stiff": {
        "description": "Coarse stiff cloth: 4x4 grid plus thicker rendered/contact cloth.",
        "model_kwargs_rownum": 0,
        "cloth_grid_count": 4,
        "geom_density": 1000.0,
        "skin_inflate": 0.002,
